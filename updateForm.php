...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col"></div>
            <div class="col-7">
                <h1 class="mt-50 centerText">Update</h1>
                <?php
                ...
                ?>
                <form  action="updateForm.php?id=<?php echo $_GET['id']?>"  method="post" class="mt-20">
                    ...
                    <div class="form-group">
                        ...
                        <textarea  id="content" class="form-control" name="content" required><?php echo $article['content'] ?></textarea>
                    </div>
                    <div class="row">
                        <div class="col"></div>
                        <div class="col-8">
                            <button type="submit" id="submit" class="btn fullWidth btn-outline-primary btn-lg mt-20" name="update" value="<?php echo $_GET['id'] ?>">Submit</button>
                        </div>
                        <div class="col"></div>
                    </div>
                </form>
